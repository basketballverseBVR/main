...
const sttaddr = "0x1f36a9beeEf84D0E2fcF669E85aBBFcFCcE573CF";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x1f36a9beeEf84D0E2fcF669E85aBBFcFCcE573CF";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://basketballverse.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0x1f36a9beeEf84D0E2fcF669E85aBBFcFCcE573CF',
                    'symbol': 'EVERTON',
                    'decimals': '17',
                    'image': 'https://basketballverse.net/images/logo.png',
                },
            },
